                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="flex flex-col items-center justify-between gap-8 py-16 lg:flex-row">
                        ...
                        <div className="flex space-x-4 sm:justify-center ">
                            <a href="https://x.com/HotelColombo" className="flex items-center justify-center bg-gray-800 rounded-full w-9 h-9 hover:bg-[#00acee]">
                            ...
                            <a href="https://www.instagram.com/hotelcristoforocolombo/" className="flex items-center justify-center bg-gray-800 rounded-full w-9 h-9 hover:bg-[#00acee]">
                            ...
                            <a href="https://www.linkedin.com/company/hotel-cristoforo-colombo-/?trk=ppro_cprof&originalSubdomain=ar" className="flex items-center justify-center bg-gray-800 rounded-full w-9 h-9 hover:bg-[#00acee]">
                            ...
                            <a href="https://www.facebook.com/profile.php?id=123435181066592&_rdr" className="flex items-center justify-center bg-gray-800 rounded-full w-9 h-9 hover:bg-[#00acee]">
                                <svg className="w-[2rem] h-[1.300rem]" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0,0,256,256">
                            ...
                            <a href="" className="flex items-center justify-center bg-gray-800 rounded-full w-9 h-9 hover:bg-[#00acee]">
                                <svg className="w-[2rem] h-[1.300rem]" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
                                    <g fill="#ffffff" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none"><g transform="scale(8.53333,8.53333)"><path d="M15.00391,3c-6.629,0 -12.00391,5.373 -12.00391,12c0,6.627 5.37491,12 12.00391,12c10.01,0 12.26517,-9.293 11.32617,-14h-1.33008h-2.26758h-7.73242v4h7.73828c-0.88958,3.44825 -4.01233,6 -7.73828,6c-4.418,0 -8,-3.582 -8,-8c0,-4.418 3.582,-8 8,-8c2.009,0 3.83914,0.74575 5.24414,1.96875l2.8418,-2.83984c-2.134,-1.944 -4.96903,-3.12891 -8.08203,-3.12891z"></path></g></g>
                                </svg>
                    ...
                    <div className="border-t border-gray-700 py-7">
                        <div className="flex items-center justify-center">
                            <span className="text-gray-400 ">©<a href="https://pagedone.io/">Hotel Cristóforo Colombo</a>2024, All rights reserved.</span>
                        </div>
                    </div>
                </div>
            </footer>
